    ...
    >
      <div>
        ...
        <div className="mt-2 flex flex-col gap-3 sm:flex-row sm:items-stretch">
          <code className="flex-1 break-all rounded-2xl border border-zinc-200 bg-zinc-50 px-4 py-3 text-xs text-zinc-800">
            {shareUrl}
          </code>
          <motion.button
            type="button"
        ...
        <p className="mt-2 inline-flex items-center rounded-full bg-zinc-100 px-3 py-1 text-xs text-zinc-600">
      ...
      <div className="rounded-2xl border border-amber-200 bg-amber-50/80 px-4 py-3 text-sm text-amber-950">
        ...
        <button
          type="button"
          className="ml-2 text-blue-700 underline decoration-blue-400 underline-offset-2 hover:text-blue-900"
        ...
        {showDelete ? (
          <div className="mt-2 space-y-2">
            <code className="block break-all rounded-lg bg-white/80 px-2 py-1 text-xs">
              {deleteToken}
            </code>
            <button
              type="button"
